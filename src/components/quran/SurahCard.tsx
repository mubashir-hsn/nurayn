  ...
  return (
    ...
    >
      <Link href={`/surah/${surah.number}`} className="block h-full w-full">
        <div className="premium-card overflow-visible! group relative p-6 bg-card aspect-square flex flex-col justify-between transition-all duration-500 w-full">
          ...
          <div className="flex items-start justify-between relative z-10 w-full">
            <div className="relative flex h-14 w-14 shrink-0 items-center justify-center">
              <div className="absolute inset-0 bg-gold/10 rounded-xl rotate-45 group-hover:bg-gold group-hover:rotate-90 transition-all duration-500" />
              <span className="relative font-bold text-xl text-primary-green group-hover:text-white transition-colors">
                {surah.number}
              </span>
            </div>
            <div className="text-right min-w-0 flex-1 ml-4">
              <h3 className="font-arabic text-3xl md:text-4xl text-primary-green group-hover:text-gold transition-colors duration-300 truncate">
                {surah.name}
              </h3>
          ...
          <div className="relative z-10 w-full mt-auto mb-4">
            <h3 className="font-extrabold text-xl md:text-2xl group-hover:text-gold transition-colors duration-300 truncate">
              {surah.englishName}
            </h3>
            <p className="text-sm text-muted-foreground font-medium truncate">{surah.englishNameTranslation}</p>
          </div>
